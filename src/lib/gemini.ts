...
export async function processDocument(
  ...
  let systemInstruction = "";
   if (mode === 'Expedientes') {
    ...
    - NÚMERO DE COMPROBANTE / FACTURA: Búscalo en la sección superior/cabecera de la liquidación, típicamente etiquetado como "Cod.017 Liq.Serv.Pub. A [número]" o "Liquidación de Servicios Públicos A [número]" (ej. "Cod.017 Liq.Serv.Pub. A 0008-00055016" -> extrae como orderNumber: "0008-00055016" o "A 0008-00055016"). PARA FACTURAS DE SERVICIO DE CLOACAS / MUNICIPALES: el número de comprobante es el campo "Boleta" (ej. "Boleta 2180052026" -> extrae como orderNumber: "2180052026"). PARA FACTURAS MUNICIPALES DE SERVICIO DE AGUA (ej. Municipalidad de San Jorge - Servicio de Agua): el número de comprobante es un número prominente de varios dígitos que aparece en el talón de pago SIN etiqueta, ubicado encima del período (mes y año, ej. "ABRIL 2026"). Ejemplo: "0040261152" aparece solo, arriba de "ABRIL 2026" -> extrae como orderNumber: "0040261152" o "40261152". Si no hay campo "Boleta" ni número sin etiqueta visible, usar el N° de cuenta o identificador más prominente.
